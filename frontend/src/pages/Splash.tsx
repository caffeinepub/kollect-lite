          ...
          <div className="relative flex items-center justify-center mb-8">
            ...
            <div className="relative w-20 h-20 rounded-full border-2 border-teal-ring flex items-center justify-center bg-white/40 animate-crosshair-spin">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="4" y1="22" x2="16" y2="22" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" />
                <line x1="28" y1="22" x2="40" y2="22" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" />
                <line x1="22" y1="4" x2="22" y2="16" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" />
                <line x1="22" y1="28" x2="22" y2="40" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" />
                <path d="M10 14 L10 10 L14 10" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                <path d="M30 10 L34 10 L34 14" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                <path d="M10 30 L10 34 L14 34" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                <path d="M34 30 L34 34 L30 34" stroke="#1E6FBF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
