...
export default function CaseCard({ caseData }: CaseCardProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 hover:shadow-md hover:border-forest-base transition-all cursor-pointer"
    >
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 px-2 py-1 bg-teal-pill border border-teal-pill-border rounded-md">
                ...
                <span className="text-xs font-semibold text-forest-dark">{caseData.phoneNumber}</span>
              </div>
            </div>
