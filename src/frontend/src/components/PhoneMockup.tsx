      ...
      <div className="relative">
        ...
        <div className="relative w-[375px] h-[812px] bg-black rounded-[3rem] shadow-2xl p-3">
          ...
          <div className="relative w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 h-11 bg-white z-10 flex items-center justify-between px-6 pt-2">
              ...
              <div className="flex items-center gap-1">
                <svg className="w-4 h-3" viewBox="0 0 16 12" fill="none">
                  <path d="M1 5.5C1 3.567 2.567 2 4.5 2h7C13.433 2 15 3.567 15 5.5v1c0 1.933-1.567 3.5-3.5 3.5h-7C2.567 10 1 8.433 1 6.5v-1z" fill="currentColor"/>
            ...
            {/* Scrollable content */}
            <div className="absolute top-11 left-0 right-0 bottom-0 overflow-y-auto">
              {children}
            </div>
          </div>
        </div>
